...
import { 
  Users, CheckCircle, Timer, AlertCircle, Calendar, Trophy, Clock,
  ArrowUpRight, ArrowDownRight, LayoutDashboard, PieChart, TrendingUp
} from 'lucide-react';
import { 
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2.2fr 1fr', gap: '2rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1.5rem' }}>
              ...
              />
              <ListCard title="Yêu cầu phê duyệt gấp" color="#f59e0b" 
                items={[
                  { label: 'Nghỉ phép thường niên', sub: 'Nguyễn Văn A', val: 'Cần duyệt' },
                  { label: 'Phê duyệt Ứng lương', sub: 'Lê Trần Thu', val: 'Cần duyệt' }
                ]} 
              />
            </div>
          </div>
